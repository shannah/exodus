...
import os,sys,re,json,urllib,urlparse,base64,datetime,traceback
    ...
    def movieDirectory(self, items):
        ...
        for i in items:
            try:
                ...
                if 'originaltitle' not in i:
                    i['originaltitle'] = i['title']
                
                imdb, title, year = i['imdb'], i['title'], i['originaltitle']
